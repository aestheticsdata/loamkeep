...
| | | |
|---|---|---|
| 0:00 | The title | the painted dawn — seven sky bands, the sun coming up behind the keep, the rabbit that also lives in the meadow — and the second entry reading LANDMARKS (EMPTY), because the browser is cold; then ENTER THE MEADOW and the twenty-frame wave wipe that carries the title under in 16-px squares |
