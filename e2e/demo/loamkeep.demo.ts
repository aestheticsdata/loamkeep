 ...
 * chapter one always opens on SKETCHBOOK (EMPTY) and the last chapter always finds exactly the
...
test("loamkeep, end to end", async ({ demo }) => {
  ...
  // the cursor blinks, the sun climbs, and the second entry reads SKETCHBOOK (EMPTY) because
